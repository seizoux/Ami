...
class TopGG(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.dbl_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjgwMTc0Mjk5MTE4NTkzNjM4NCIsImJvdCI6dHJ1ZSwiaWF0IjoxNjMwMDY5MTE3fQ.7WrUF7ZmX7u14IM0zyhgs-QPHan1QqubZ1zC0rLJumI"  # set this to your bot's Top.gg token
        self.dblpy = topgg.DBLClient(self.bot, self.dbl_token)
        self.topgg_webhook = topgg.WebhookManager(self.bot).dbl_webhook("/amiwebhook", "topggwebhookami")
        self.topgg_webhook.run(44444)
