...
class Info(commands.Cog):
    ...
    async def info(self, ctx):
        ...
        em.add_field(name=f"<:info:819702267480899634> Developer Information", value = f"<:greenarrow:819706481883611197> Name » `Daishiky#0828`\n<:greenarrow:819706481883611197> Based in » `Europe/Italy`\n<:greenarrow:819706481883611197> Age » `18y/o`\n<:greenarrow:819706481883611197> DM Me » **{me}**", inline = False)
