...
class Help(commands.Cog):
    ...
    async def help(self, ctx, command=None):
        if not command:
            ...
            while True:
                lists = ["1713_rem_neutral_face", "6730_1_first", "7337_Furry_Dance_Green", "4626_FoxWave",
                         "7280_PandaGrimReaper", "1739_CMD", "no", "bigbrain", "pepoS", "Hehe"]
