        ...
        if command == None:
            ...
            while True:
                ...
                if payload.emoji.name == "no":
                    ...
                    embed=discord.Embed(title="Moderation commands", description=f"• `ban`, `kick`, `mute`, `unban`, `unmute`, `clear`, `slowmode`, `antispam`", color=0xffcff1)
                    ...
                    embed=discord.Embed(title="Music commands", description=f"• `play`, `volume`, `leave`, `pause`, `resume`, `summon`, `shuffle`, `queue`, `remove`, `skip`, `now`", color=0xffcff1)
                    embed.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar_url}")
                    await msg.edit(embed=embed)
                    ...
                    embed=discord.Embed(title="Fun commands", description=f"• `lick`, `kiss`, `kill`, `slap`, `hug`, `punch`, `pat`, `echo`, `nitro`, `ship`, `rspeed`, `ph`, `devquiz`, `choose`, `time`, `emojis`, `roast`, `amg`, `wide`, `stk`", color=0xffcff1)
                    embed.set_author(name=f"{ctx.author.name}", icon_url=f"{ctx.author.avatar_url}")
                    await msg.edit(embed=embed)
