...
class IpcRoutes(commands.Cog):
    ...
    async def get_bot_stats(self, data) -> int:
        ...
        return {"guilds": len(self.bot.guilds), "users": sum([g.member_count for g in self.bot.guilds]), "players": len(self.bot.wavelink.players), "commands": humanize.intcomma(self.bot.command_counter), "uptime": final_date, "shards": shards, "usage": ram_usage, "topguilds": guilds}
