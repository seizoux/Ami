...
class Boosting(commands.Cog):
    ...
    @commands.group(help="Configure the boosting feature for your guild, and welcome new booster in a good way!\nThe message you set, if you have embed enabled, will be automatically placed as embed description.\n"
                            ...
                            "`ami setboost modality enable / disable` to enable / disable the boosting module\n"
