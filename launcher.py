...
CLUSTER_NAMES = (
    ...
    'Cluster-17', 'Cluster-18', 'Cluster-19', 'Cluster-20', 'Cluster-21', 'Cluster-22', 'Cluster-23', 'Cluster-24', 'Cluster-25'
)
...
class Launcher:
    ...
    def get_shard_count(self):
        data = requests.get('https://discordapp.com/api/v7/gateway/bot', headers={
            ...
            "User-Agent": "DiscordBot (https://github.com/Rapptz/discord.py 1.7.3) Python/3.7 aiohttp/3.6.1"
        })
